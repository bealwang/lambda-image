...
class Data(object):
    """
    Generic base class for data types in MEHI.
    ...
    def astype(self, dtype, casting='safe'):
        ...
        to which they can be cast safely, as determined by the MEHI.utils.common smallest_float_type function.
    ...
    def stats(self, requestedStats='all', dtype='float64', casting='safe'):
        ...
        """
        from MEHI.utils.statcounter import StatCounter
