...
class lambdaimageContext():
    ...
    def loadJSON(self, path):
        ...
        import json
        from lambdaimage.rdds.fileio.readers import getFileReaderForPath, FileNotFoundError
        from lambdaimage.utils.serializable import _decode_dict
    ...
    def loadSources(self, path):
        ...
        SourceExtraction
        """
        from lambdaimage import SourceExtraction
