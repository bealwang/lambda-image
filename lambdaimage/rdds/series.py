...
from lambdaimage.utils.common import loadMatVar
...
class Series(Data):
    ...
    def toBlocks(self, size="150M"):
        ...
        Blocks instance
        """
        from lambdaimage.rdds.imgblocks.strategy import BlockingStrategy, SeriesBlockingStrategy
        ...
        if avgSize >= BlockingStrategy.DEFAULT_MAX_BLOCK_SIZE:
            ...
            print "lambdaimage WARNING: average block size of %g bytes exceeds suggested max size of %g bytes" % \
