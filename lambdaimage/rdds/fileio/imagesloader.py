...
from lambdaimage.rdds.fileio.readers import getParallelReaderForPath, getFileReaderForPath, FileNotFoundError
...
class ImagesLoader(object):
    ...
    def fromArrays(self, arrays, npartitions=None):
        ...
        on the driver is likely prohibitive in the use cases for which lambdaimage is intended.
        """
    ...
    def fromTif(self, dataPath, ext='tif', startIdx=None, stopIdx=None, recursive=False, nplanes=None,
        ...
        unsuccessful. (PIL/pillow is not an explicit requirement for lambdaimage.)
        ...
        if isPillow:
            ...
            from lambdaimage.utils.common import pil_to_array
